...
from Tests.test_base import BaseTestAPI
...
class Tests(BaseTestAPI):
    ...
    def test_post_create_user(self):
        result = self.API.execute_request(self, load_address("API") + "api/users", "POST",
    ...
    def test_get_single_user(self):
        result = self.API.execute_request(self, load_address("API") + "api/users/12", "GET")
    ...
    def test_patch_single_user(self):
        result = self.API.execute_request(self, load_address("API") + "api/users/12", "PATCH",
    ...
    def test_put_single_user(self):
        result = self.API.execute_request(self, load_address("API") + "api/users/12", "PUT",
    ...
    def test_delete_single_user(self):
        result = self.API.execute_request(self, load_address("API") + "api/users/12", "DELETE")
